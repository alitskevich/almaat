...
- **Broker structural holes.** Step outside your professional and class capsule for non-redundant `Information` — the engineer at the restoration lecture, the lawyer at the poetry slam — to let fresh data into the system.
