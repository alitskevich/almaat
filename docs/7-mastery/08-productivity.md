...
- **Shutdown Ritual (Friday)**: Set Monday's top 3 priorities. End with a verbal cue ("Week over"). Cognitive closure enables real rest.

The quarterly cadence belongs to direction rather than execution — see [Vision → Seasons](03-vision.md#seasons).
