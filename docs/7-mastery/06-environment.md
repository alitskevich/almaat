...
- Make undesired behaviors harder (charge the phone in another room).
...
**The "Butler" trick**: treat your current self as a butler for your future self — set out the coffee machine, lay out your clothes, prepare everything the night before. This lowers the activation energy needed to act in the morning. Prepare the *objects* at night; make the *decisions* while still rested — see [The Shape of the Day](07-attention.md#the-shape-of-the-day).
...
**Identity, connection, patience.** "I don't smoke" works better than "I'm trying to quit" — `Behavior` follows `Identity`, and identity is built from small proofs (see [Building Habits](05-habits.md#building-habits)). Bruce Alexander's "Rat Park" experiments showed connection and environment are part of the mechanism: isolation deepens compulsion, a rich environment loosens it. The core freedom lives in the gap between stimulus and response — the stimulus fires, but the response is yours to place.
