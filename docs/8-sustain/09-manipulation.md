...
Cialdini's principles of influence are neutral tools — persuasion when honest, manipulation when concealed.
...
**The universal counter** — almost every tactic dies to four moves: **gray rock** (minimal emotion, minimal information — nothing to work with), **name it** (manipulation needs to stay invisible), **slow it** (see [Composure](07-frame.md#composure)), and **hold the frame** (return to your position unchanged).

## Conditioning

Manipulation hijacks the `Animal` in a single moment; **conditioning** shapes behavior across many.
