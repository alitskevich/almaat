...
Modern conformism is not the obvious coward who runs or betrays. It is the decent person who believes being good means not making trouble, not rocking the boat, doing what is expected. Erich Fromm called this *automaton conformity* (*Escape from Freedom*, 1941): not trembling and hiding, but functioning without ever asking a question.
...
Conformism is produced, not innate.

- **School** rewards the one right answer and corrects the child who doubts the authority.
- **Social media** adds real-time, measured pressure: likes and shares reward agreement with the current majority and punish independence, and every opinion became a public act, making self-censorship rational.
- **The workplace** reads dissent as disloyalty.

## The Continuum of Destruction

Ervin Staub studied how ordinary people become accomplices to mass killing. It never starts with an order to kill; it starts with a small step — one group barred from a café, then restricted, then fired, then fined. Each step is small and justified by safety or order, and most stay silent because it does not touch them. But silence is consent, and each next step is easier because the last met no resistance. To live with the harm, people devalue the victim: "they brought it on themselves." That is not the psychology of a villain but of an ordinary person defending one small choice to stay quiet.
...
What separated those who refused was where they placed responsibility. They said "I am responsible for this"; those who continued said "I am only following instructions." Delegating responsibility is the heart of conformism — its antidote is [Accountability](../7-mastery/02-mindset.md#accountability).

Solzhenitsyn reduced the standard to a minimum that needs no heroism: do not support a lie with your silence, do not applaud what you think is wrong, do not say what you do not think.

Inner freedom is handed over gradually and voluntarily, because self-perception runs both ways: behave like a coward and you come to see yourself as one; act with a position and that becomes who you take yourself to be. See [Identity over behavior](../7-mastery/05-habits.md#building-habits).
